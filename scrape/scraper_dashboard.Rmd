...
```
<p>
(The ~13,000 species in the _OutOf_ column (via _SISRecID_) correspond to those listed in a Birdlife species spreadsheet provided by Stu Butchart. However, status was ascertained by crawling _DataZone_ pages and was not contained in the spreadsheet. The 2,027 species with 'unknown' status are simply those not included in the crawl. Their status should be known but is not currently present in the database.)
