...
```{r scanned-journals, echo = FALSE}
Journals <- c('Avian Conservation & Ecology', 
              'Avian Research',
              ...
              'PLOS One')
URLs <- c('https://www.ace-eco.org',
          'https://avianres.biomedcentral.com',
          'https://cambridge.org/core/journals/bird-conservation-international',
          ...
          'https://www.nisc.co.za/products/11/journals/ostrich-journal-of-african-ornithology',
          'https://journals.plos.org')

knitr::kable(data.frame(Journals, URLs))
```

### Text retrieval

The following domains did not permit any text or pdf scraping and will be excluded from the analysis below:
...
Among the remaining domains, the following counts show URLs from which text was retrieved (1) versus not (0):
...
Note that the bimodal distribution for *ace-eco.org* is arises as an artefact of the scoring algorithm. (It arises because of the presence of French-language text, and _process_ either needs to account for this in the scoring algorithm, or to incorporate language translation.)


### Date range

How well are we able to parse dates for URLs?
