...
source('/Volumes/blitshare/pg/param.R')
...
The
<a href="http://blitscansql.uksouth.azurecontainer.io:3838/">BlitScan app</a> is built over a data set of journal articles/research publications:
