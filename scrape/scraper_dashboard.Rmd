...
In particular, as of June 2022, translation services hav not yet been switched on, and untranslated articles will all be filtered out. We expet a significant movement from 'OutOf' to 'Count' as soon as translation is in effect.
...
Finally, we summarise the success or not, by domain, of text retrieval. We've indicated above ('Step 1 revisited') that not all domains consistently permit web crawling. Among responsive domains, the following counts show URLs from which text was retrieved (1) versus not (0):
