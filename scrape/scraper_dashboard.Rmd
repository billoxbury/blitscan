...
cat("Number of journals:", nrow(tx_journals), '\n')
```
...
More detail on journal and publishers is given below. A full list of journals the database draws from is given in the appendix.
...
### Appendix: list of all journals

The listing below makes use of the open source project <a href="https://www.crossref.org/">CrossRef</a>. At each of the steps in the _scrape_ process we record the <a href="https://www.doi.org/">Digital Object Identifier (DOI)</a> of each article. CrossRef then allows us to query all DOIs in the Blitscan database to obtain a rich set of metadata. The list below is extracted from that set. 
