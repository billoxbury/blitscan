...
At present, the only metrication is a page _bli_data_dashboard.html_ in the _reports_. This documents EDA for the BirdLife training data text and is generated by the script _bli_data_dashboard.Rmd_ in the _models_ folder.
